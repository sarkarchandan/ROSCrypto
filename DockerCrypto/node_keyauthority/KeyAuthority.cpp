#include "ros/ros.h"
#include "node_keyauthority/key_generator.h"
#include "Matrix.hpp"
...
bool ServiceCalled(node_keyauthority::key_generator::Request& _request,node_keyauthority::key_generator::Response& _response)
{
